...
from flask_cors import CORS,cross_origin  # Import Flask-CORS for CORS configuration
...
# Feature extraction testing route
@app.route('/extract_features', methods=['POST'])
@cross_origin()
def extract_features():
    audio_file = request.files['audio']
    features = featureExtraction.extract_audio_features(audio_file)
